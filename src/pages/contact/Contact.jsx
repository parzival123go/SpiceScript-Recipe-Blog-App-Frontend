                  ...
                  <div className="relative h-full">
                    ...
                    <div className="absolute bottom-0 w-full lg:p-11 p-5">
                      <div className="bg-white rounded-lg p-6 block">
                        ...
                        <a href="mailto:hello@spicescript.com" className="flex items-center mb-6">
                          <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                          ...
                          <h5 className="text-black text-base font-normal leading-6 ml-5">hello@spicescript.com</h5>
                        </a>
                        <div className="flex items-center">
                          ...
                          <h5 className="text-black text-base font-normal leading-6 ml-5">654 Sycamore Avenue, Meadowville, WA</h5>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="flex">
                    <div className="flex items-center mr-11">
                      <input 
                        ...
                        className="mr-2"
                      />
                      <label htmlFor="radio-group-1" className="cursor-pointer text-gray-500 text-base">
                        Email
                      </label>
                    </div>
                    <div className="flex items-center">
                      <input 
                        ...
                        className="mr-2"
                      />
                      <label htmlFor="radio-group-2" className="cursor-pointer text-gray-500 text-base">
                        Phone
                      </label>
                    </div>
                  </div>
